...
public class BuildScript : MonoBehaviour, IPostprocessBuildWithReport
{
    ...
    private const string PRODUCT_NAME = "UnityCICDProject";
    // project settings - player - package name
    private const string IDENTIFIER = "com.yoonsangmin.UnityCICDProject";
    // keystore path
    private const string KEYSTORE_NAME = "src/user.keystore";
    // keystore password
    private const string KEYSTORE_PASS = "qwer1234";
    // keyalias name
    private const string KEYALIAS_NAME = "yoonsangmin";
    // keyalias password
    private const string KEYALIAS_PASS = "qwer1234";
